...
public class TransactionContoller 
{
	...
	{
		return transactionService.getTransactionId( tid );
	}
	public int getBeneficiaryAccNo( int tid  )
	{
		return transactionService.getBeneficiaryAccNo( tid );
	}
	public int getBalance( int tid  )
	{
		return transactionService.getBalance( tid );
	}
	public int getTransactionAmount( int tid )
	{
		return transactionService.getTransactionAmount( tid  );
	}
	public int getAvailableBalance( int tid  )
	{
		return transactionService.getAvailableBalance( tid );
	}
